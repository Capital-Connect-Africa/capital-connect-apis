...
export class UpdateInvestorProfilesTable1733224452820 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "investor_profiles" ADD "availableFunding" integer`);
        await queryRunner.query(`UPDATE "investor_profiles" SET "availableFunding" = CAST("availableFunding" AS integer)`);
        await queryRunner.query(`ALTER TABLE "investor_profiles" DROP COLUMN "availableFunding"`);
    }
}
