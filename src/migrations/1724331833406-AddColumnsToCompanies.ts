...
export class AddColumnsToCompanies1724331833406 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "companies" ADD "investmentStructure" character varying NOT NULL DEFAULT ''`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "companies" DROP COLUMN "investmentStructure"`);
    }
