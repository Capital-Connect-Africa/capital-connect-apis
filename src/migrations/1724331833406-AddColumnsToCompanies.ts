...
export class AddColumnsToCompanies1724331833406 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "companies" ADD "investmentStructures" character varying NOT NULL DEFAULT 'default_value'`);
        await queryRunner.query(`ALTER TABLE "companies" ADD "useOfFunds" character varying NOT NULL DEFAULT 'default_value'`);
        await queryRunner.query(`ALTER TABLE "companies" ADD "esgFocusAreas" character varying NOT NULL DEFAULT 'default_value'`);
