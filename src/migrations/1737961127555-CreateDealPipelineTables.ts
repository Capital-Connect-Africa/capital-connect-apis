...
export class CreateDealPipelineTables1737961127555
  implements MigrationInterface
{
  name = 'CreateDealPipelineTables1737961127555';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "deal-attachments" ("id" SERIAL NOT NULL, "dealId" integer NOT NULL, "attachmentId" integer NOT NULL, CONSTRAINT "PK_b6f51be0e4ee224107104a8f3cd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."deals_status_enum" AS ENUM('won', 'lost', 'active', 'cancelled')`,
    );
    await queryRunner.query(
      `CREATE TABLE "deals" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "status" "public"."deals_status_enum" NOT NULL DEFAULT 'active', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer NOT NULL, "customerId" integer NOT NULL, "stageId" integer NOT NULL, CONSTRAINT "PK_8c66f03b250f613ff8615940b4b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
