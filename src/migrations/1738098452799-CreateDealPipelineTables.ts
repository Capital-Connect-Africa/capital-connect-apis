...
export class CreateDealPipelineTables1738098452799
  implements MigrationInterface
{
  name = 'CreateDealPipelineTables1738098452799';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "deals" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "value" numeric(20,2) NOT NULL, "status" "public"."deals_status_enum" NOT NULL DEFAULT 'active', "closedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "ownerId" integer NOT NULL, "customerId" integer NOT NULL, "currentStageId" integer NOT NULL, CONSTRAINT "PK_8c66f03b250f613ff8615940b4b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "deals" ADD CONSTRAINT "FK_5c949249deb3003aee0d1964ff2" FOREIGN KEY ("currentStageId") REFERENCES "deal-stages"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "deals" DROP CONSTRAINT "FK_5c949249deb3003aee0d1964ff2"`,
    );
    await queryRunner.query(
