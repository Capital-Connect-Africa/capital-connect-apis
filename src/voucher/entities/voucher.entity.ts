...
export class Voucher {
  ...
  @ApiProperty({
    enum: VoucherType,
    description: 'Essentially the package the voucher can apply to',
  })
  type: VoucherType;
  ...
  @ApiProperty({
    description: 'Datetime when the validity of a voucher ceases',
  })
  expiresAt: Date;
  ...
  @ApiProperty({
    description: 'Datetime when the details of the voucher were last modified',
  })
  updatedAt: Date;
  ...
  @ApiProperty({
    ...
    description: 'An array of Rules applicable to this voucher',
  })
  ...
  @ApiProperty({
    type: [UserVoucher],
    description: 'An array of users who already redeemed the voucher',
  })
  users: UserVoucher[];
}
